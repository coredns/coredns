...
func TestNewRule(t *testing.T) {
	tests := []struct {
		...
		{[]string{"name", "suffix", "a.com", "b.com", "answer", "question"}, false, reflect.TypeOf(&suffixNameRule{})},
		{[]string{"name", "suffix", "foo3.bar", "google.com", "answer", "name", `g(o+)gle(.*)`, "f{1}{2}"}, false, reflect.TypeOf(&suffixNameRule{})},
		{[]string{"name", "substring", "a.com", "b.com"}, false, reflect.TypeOf(&substringNameRule{})},
		{[]string{"name", "substring", "a.com", "b.com", "answer", "question"}, false, reflect.TypeOf(&substringNameRule{})},
		...
		{[]string{"name", "regex", "(dns)\\.(core)\\.(rocks)", "{2}.{1}.{3}", "answer", "question"}, false, reflect.TypeOf(&regexNameRule{})},
