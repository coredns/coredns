...
func TestNewRule(t *testing.T) {
	tests := []struct {
		...
		{[]string{"name", "suffix", "a.com", "b.com"}, false, reflect.TypeOf(&nameRule{})},
		{[]string{"name", "suffix", "foo3.bar", "google.com", "answer", "name", `g(o+)gle(.*)`, "f{1}{2}"}, false, reflect.TypeOf(&nameRule{})},
		{[]string{"name", "substring", "a.com", "b.com"}, false, reflect.TypeOf(&nameRule{})},
		{[]string{"name", "regex", "([a])\\.com", "new-{1}.com"}, false, reflect.TypeOf(&nameRule{})},
		{[]string{"name", "regex", "([a]\\.com", "new-{1}.com"}, true, nil},
		{[]string{"name", "regex", "(dns)\\.(core)\\.(rocks)", "{2}.{1}.{3}", "answer", "name", "(core)\\.(dns)\\.(rocks)", "{2}.{1}.{3}"}, false, reflect.TypeOf(&nameRule{})},
		...
		{[]string{"name", "substring", "fcore.dns.rocks", "dns.fcore.rocks", "answer", "name", "(fcore)\\.(dns)\\.(rocks)", "{2}.{1}.{3}"}, false, reflect.TypeOf(&nameRule{})},
