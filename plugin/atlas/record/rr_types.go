...
//go:generate go run marshaller_generate.go --type CNAME,HINFO,MB,MG,MINFO,MR,MF,MD,MX,AFSDB,X25,RT,NS,PTR,RP,TXT,SPF,AVC,SRV,NAPTR,CERT,DNAME,A,AAAA,PX,GPOS,LOC,SIG,RRSIG,NSEC,DLV,CDS,DS,KX,TA,TALINK,SSHFP,KEY,CDNSKEY,DNSKEY,IPSECKEY,AMTRELAY,RKEY,NSAPPTR,NSEC3,NSEC3PARAM,TKEY,RFC3597,URI,DHCID,TLSA,SMIMEA,HIP,NINFO,NID,L32,L64,LP,EUI48,EUI64,CAA,EID,NIMLOC,OPENPGPKEY,CSYNC,ZONEMD,APL,APLPrefix
type CNAME struct {
